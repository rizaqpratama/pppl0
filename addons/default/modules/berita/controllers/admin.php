...
class Admin extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $extra['title'] = 'lang:berita:beritas';
        ...
        $extra['buttons'] = array(
            array(
                ...
                'url' => 'admin/berita/edit/-entry_id-'
            ),
            array(
                'label' => lang('global:delete'),
                'url' => 'admin/berita/delete/-entry_id-',
                'confirm' => true
            )
        );
    ...
    public function create()
    {
        $extra = array(
            'return' => 'admin/berita',
            'success_message' => lang('berita:submit_success'),
            'failure_message' => lang('berita:submit_failure'),
            'title' => 'lang:faq:new',
         );

        $this->streams->cp->entry_form('beritas', 'berita', 'new', null, true, $extra);
    }
    ...
    public function edit($id = 0)
    {
        $extra = array(
            ...
            'success_message' => lang('berita:submit_success'),
            'failure_message' => lang('berita:submit_failure'),
            'title' => 'lang:berita:edit'
        );

        $this->streams->cp->entry_form('beritas', 'berita', 'edit', $id, true, $extra);
    }
    ...
    {
        $this->streams->entries->delete_entry($id, 'beritas', 'berita');
        $this->session->set_flashdata('error', lang('berita:deleted'));
